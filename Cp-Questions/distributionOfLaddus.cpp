...
you need to help the boss to distribute again such that all of them get equal Laddus  if its not possible to distribute equally then no one will get Laddus
